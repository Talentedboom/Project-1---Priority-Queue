...
public class Driver {
  ...
  public static void main(String[] args) {
    ...
    System.out.println(  ); 
    ResourceManagement.printNames( );
    System.out.println(  );

    //Call student solution for the test files:
    double budgets[] = {41850.00, 0.01, 27961.10};
    for( int i=0; i<3; i++ )
      testFile( new ArrayList<String>(Arrays.asList(fileNames[i])), budgets[i] );
  ...
  public static void testFile( ArrayList<String> fileNames, double budget ) {  
